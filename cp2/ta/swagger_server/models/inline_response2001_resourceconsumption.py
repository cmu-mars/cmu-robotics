...
class InlineResponse2001Resourceconsumption(Model):
    ...
    """
    def __init__(self, num_attempts: int=None, time_spent: float=None):
        """
    ...
    def from_dict(cls, dikt) -> 'InlineResponse2001Resourceconsumption':
        ...
        :param dikt: A dict.
        :type: dict
        :return: The inline_response_200_1_resourceconsumption of this InlineResponse2001Resourceconsumption.
    ...
    def num_attempts(self) -> int:
        ...
        Number of attempted adaptations.
    ...
    def time_spent(self) -> float:
        ...
        Wall-clock time spent searching for an adaptation.
    ...
    def time_spent(self, time_spent: float):
        ...
        :type time_spent: float
        """
        if time_spent is not None and time_spent < 0.0:
            raise ValueError("Invalid value for `time_spent`, must be a value greater than or equal to `0.0`")
