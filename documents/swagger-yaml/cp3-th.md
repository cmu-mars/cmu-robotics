...
|Name|Description|Schema|
|---|---|---|
|**ERROR**  <br>*required*|one of a enumerated set of reasons that errors may arise|enum (BOOTING, BOOTED, ONLINE, PERTURBATION_DETECTED, MISSION_SUSPENDED, MISSION_RESUMED, MISSION_HALTED, MISSION_ABORTED, ADAPTATION_INITIATED, ADAPTATION_COMPLETED, ADAPTATION_STOPPED, TEST_ERROR)|
