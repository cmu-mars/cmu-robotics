...
class InlineResponse2003(Model):
    ...
    """
    def __init__(self, x: float=None, y: float=None, battery: int=None, sim_time: int=None, lights: List[str]=None):
        """
        ...
        :type sim_time: int
        :param lights: The lights of this InlineResponse2003.
    ...
    def lights(self) -> List[str]:
        """
        Gets the lights of this InlineResponse2003.
        the list of names from LIGHTSET of those lights which are currently turned on. all other lights are currently turned off.

        :return: The lights of this InlineResponse2003.
        :rtype: List[str]
        """
        return self._lights

    @lights.setter
    def lights(self, lights: List[str]):
        """
        ...
        """
        if lights is None:
            raise ValueError("Invalid value for `lights`, must not be `None`")
